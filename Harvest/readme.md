...
To run harvest_calibration_simPkgs.R, please copy the initial file named /harvest/biomass-harvest.txt into your working directory (dir_path). This file contains the harvest prescription details.
---
